...
function AddModerator() {
  ...
  const onSubmit = async v => {
    ...
    try {
      const moderatorRole = await web3.getModeratorRole()
      walletConnect.sendRequest(userAddress, sessionTopic, web3.grantRoleData(moderatorRole, addressRef.current.value))
        .then(() => {
    ...
    <div className="modal-dialog">
      <div className="modal-content">
        <div className="modal-header">
          <h5 className="modal-title">Add moderator</h5>
