  ...
  return (
    <svg width="198" height="198" fill="none" xmlns="http://www.w3.org/2000/svg">
      <animated.path
        ...
        fill="#FFFFFF"
      />
      <animated.rect style={animHor1} x="65" y="58" width="68" height="5" rx="2.5" fill="#FFFFFF" />
      <animated.rect style={animVer1} x="135" y="65" width="5" height="68" rx="2.5" fill="#FFFFFF" />
      <animated.rect style={animHor2} x="65" y="135" width="68" height="5" rx="2.5" fill="#FFFFFF" />
      <animated.rect style={animVer2} x="58" y="65" width="5" height="68" rx="2.5" fill="#FFFFFF" />
    </svg>
