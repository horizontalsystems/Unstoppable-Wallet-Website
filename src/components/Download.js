      ...
      <div className="position-relative text-center p-5">
        ...
        <div className="mx-auto">
          <div className="d-grid gap-3 d-sm-flex justify-content-center">
            <a href="https://play.google.com/store/apps/details?id=io.horizontalsystems.bankwallet" type="button"
            ...
            <a href="https://itunes.apple.com/app/bank-bitcoin-wallet/id1447619907?ls=1&mt=8" type="button"
               className="btn btn-warning d-flex align-items-center rounded-5 px-5">
          ...
          <div className="d-grid gap-3 d-sm-flex justify-content-center my-4">
            ...
            <a href="https://github.com/horizontalsystems/unstoppable-wallet-android/releases"
               className="d-flex align-items-center px-4 text-decoration-none text-white">
              <Image src="/icons/android.png" alt="" width="16" height="16" />
              <span className="ms-2">APK file</span>
            </a>
            <a href="https://testflight.apple.com/join/JaKdKPY5" className="d-flex align-items-center px-4 text-decoration-none text-white">
