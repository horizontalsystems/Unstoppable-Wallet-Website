# How to use mnemonic passphrases?

Mnemonic passphrase adds additional security layer to the wallet by making it difficult for someone unauthorized to gain access to the wallet even if that person manages to get a mnemonic phrase.
...
That said, keep in mind that practically speaking breaking into a wallet that has a compromised mnemonic phrase is not impossible. When mnemonic phrases are compromised the security of the wallet will heavily depend on the way passphrase was chosen. Therefore, the passphrase should not be some random English word but a combination of letter numbers, the longer the better.
