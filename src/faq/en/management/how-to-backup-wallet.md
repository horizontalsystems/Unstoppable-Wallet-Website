...
Wallet backup is one of the most important steps. User have to follow instructions and complete backup steps for each wallet in the Unstoppable app.
...
Users are not be able to receive funds to a non-backed up wallet. While some found this inconvenient it was put in place to minimize cases where users operate wallets without having backups.
